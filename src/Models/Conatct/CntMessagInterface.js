  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case "email":
        ...
        return "";
      case "phone":
        if (value && !/^\d{10,10}$/.test(value)) return langContent.errors?.invalidPhone || "Invalid phone";
        return "";
      case "message":
      ...
      <div className={`w-full py-5 flex items-center justify-center relative text-neutral-500`}>
        ...
        <div className={`w-[90%] flex flex-col lg:flex-row text-center lg:text-left  items-stretch ${language==="ar"&&'lg:flex-row-reverse  lg:text-right'}  justify-center relative gap-4`}>
          <div className={`lg:w-[55%] w-full flex flex-col ${language=="ar"&&" items-end"}`}>
            <p>{langContent.always_listening}</p>
            <h1 className={`text-blue-500 text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-5 w-[95%] ${language==="ar"&&'mt-8 text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl'}`}>
              <b>{langContent.main_heading}</b>
            </h1>
            <p className={` ${language==="ar"?'text-right':"text-justify"}`}>{langContent.description1}</p>
            <p className={` ${language==="ar"?'text-right':"text-justify"}`}>{langContent.description2}</p>

            <div className={`w-full gap-3 flex flex-col bg-white/5 border-[0.5px] border-black/20 backdrop-blur-xl h-auto shadow-xl mt-3 rounded-[15px]  ${language==="ar"?'text-right':"text-left"} lg:rounded-[30px] p-[5px]  lg:p-[20px]  overflow-hidden relative`}>
              <a
                href="tel:0522705858"
          ...
          <div className={`lg:w-[45%] w-full ${language=="ar"?"text-right":"text-left"} bg-white/50 text-blue-500 rounded-[30px] p-[20px] shadow-xl border-[0.5px] border-black/20  flex relative overflow-hidden items-center flex-col justify-center`}>
            ...
            <div className={`flex w-full gap-4 mt-5 relative`}>
