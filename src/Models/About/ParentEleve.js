            ...
            <div id={id} ref={motherRef} className={`w-[90%] flex items-center justify-center flex-col mt-10 ${language === "ar" ? 'text-right text-xl' : ''}`}>
                ...
                <div className={`w-full flex flex-col md:flex-row items-stretch mt-28 gap-5`}>
                    ...
                    <div className={`flex-1 text-neutral-600 `}>
                        ...
                        <motion.h1 {...rightAnimation(0.2)} className={`text-red-500 text-4xl md:text-7xl mb-5`}><b>{parent.heading[language]}</b></motion.h1>
                        ...
                        <div className={`w-full flex items-center justify-center mt-10 ${language === 'ar' && 'flex-row-reverse'}`}>
                            <motion.div {...rightAnimation(0)} className={`w-[20%] flex items-center justify-center p-2`}>
                                <div className={`w-12 h-12 md:w-20 md:h-20 bg-red-500 rounded-full flex items-center justify-center text-2xl md:text-4xl text-white font-extrabold`}>1</div>
                            </motion.div>
                            <div className={`w-[80%]`}>
                        ...
                        <div className={`w-full flex items-center justify-center mt-10 ${language === 'ar' && 'flex-row-reverse'}`}>
                            <motion.div {...rightAnimation()} className={`w-[20%] flex items-center justify-center p-2`}>
                                <div className={`w-12 h-12 md:w-20 md:h-20 bg-red-500 rounded-full flex items-center justify-center text-2xl md:text-4xl text-white font-extrabold`}>2</div>
                            </motion.div>
                            <div className={`w-[80%]`}>
                        ...
                        <div className={`w-full flex items-center justify-center mt-10 ${language === 'ar' && 'flex-row-reverse'}`}>
                            <motion.div {...rightAnimation()} className={`w-[20%] flex items-center justify-center p-2`}>
                                <div className={`w-12 h-12 md:w-20 md:h-20 bg-red-500 rounded-full flex items-center justify-center text-2xl md:text-4xl text-white font-extrabold`}>3</div>
                            </motion.div>
                            <div className={`w-[80%]`}>
                ...
                <div className={`w-full flex flex-col-reverse md:flex-row items-stretch mt-28 gap-10`}>
                    <div className={`flex-1 text-neutral-600`}>
                        ...
                        <motion.h1 {...leftAnimation(0.2)} className={`text-blue-500 text-4xl md:text-7xl mt-3 mb-5`}><b>{student.heading[language]}</b></motion.h1>
                        ...
                        <div className={`w-full flex items-center justify-center mt-10 ${language === 'ar' && 'flex-row-reverse'}`}>
                            <motion.div {...leftAnimation(0)} className={`w-[20%] flex items-center justify-center p-2`}>
                                <div className={`w-12 h-12 md:w-20 md:h-20 bg-blue-500 rounded-full flex items-center justify-center text-2xl md:text-4xl text-white font-extrabold`}>1</div>
                            </motion.div>
                            <div className={`w-[80%]`}>
                        ...
                        <div className={`w-full flex items-center justify-center mt-10 ${language === 'ar' && 'flex-row-reverse'}`}>
                            <motion.div {...leftAnimation()} className={`w-[20%] flex items-center justify-center p-2`}>
                                <div className={`w-12 h-12 md:w-20 md:h-20 bg-blue-500 rounded-full flex items-center justify-center text-2xl md:text-4xl text-white font-extrabold`}>2</div>
                            </motion.div>
                            <div className={`w-[80%]`}>
                        ...
                        <div className={`w-full flex items-center justify-center mt-10 ${language === 'ar' && 'flex-row-reverse'}`}>
                            <motion.div {...leftAnimation()} className={`w-[20%] flex items-center justify-center p-2`}>
                                <div className={`w-12 h-12 md:w-20 md:h-20 bg-blue-500 rounded-full flex items-center justify-center text-2xl md:text-4xl text-white font-extrabold`}>3</div>
                            </motion.div>
                            <div className={`w-[80%]`}>
