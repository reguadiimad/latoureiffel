...
const NouvellesAct = () => {
    ...
    return (
        <div className="w-[90%]  md:my-20  flex-col flex  justify-center  text-neutral-900">

            <div className="w-full flex  flex-col md:flex-row  items-center mb-10 ">
                <motion.div {...costumeAnimtion('-100%')} className="flex-1 md:mr-[6%] text-5xl md:text-9xl  ">
                    <span className="flex">
                    ...
                    <h1 className="font-normal w-full tracking-wide mb-2"><b>DIGITALISÉE</b></h1>
                    ...
                    <p className="w-full text-neutral-900/40 mt-3 text-[10px] md:text-base text-justify ">
                ...
                <motion.div {...costumeAnimtion('70%')} className="flex-1 overflow-hidden rounded-b-[50px] z-0 iphone relative scale-[0.7] md:scale-[1] -mt-10 md:mt-0">
                    ...
                    <div className=" w-full h-full top-0 left-0 z-20 p-10 pt-16 relative">
                        ...
                        <motion.img {...costumeAnimtion('-100%','100%')} alt='img' src={process.env.PUBLIC_URL+'/images/phone.png'} className="h-96 w-auto absolute bottom-0 -right-36"/>
                        ...
                        <ul className="mt-14 text-neutral-900/40 ">
                            ...
                            <li className="text-sm ">Notre équipe est prête à vous aider à tout moment.</li>
            ...
            <motion.div {...costumeAnimtion('0%','100%',100,10)} ref={ref} className="w-full flex flex-col md:flex-row overflow-hidden md:bg-neutral-100  py-12 rounded-[50px] -mt-20 md:mt-2 text-center md:text-left ez relative">
                ...
                <div className="absolute top-2 w-full flex items-center justify-center md:hidden">
                    {[1, 2, 3, 4].map((item, index) => (
                        <div key={index} onClick={() => handleClick(index)} className={`cursor-pointer px-2 yt h-[40px] flex items-end justify-end ${activeIndex === index ? "font-semibold text-2xl text-neutral-900" : "hover:animate-pulse text-[12px] text-neutral-900/50"}`}>
                            0{item}
                        </div>
                    ))}
                </div> 
             ...
             <div className="flex-1 px-10 overflow-hidden text-base md:text-2xl  z-10 h-full md:pt-0 pt-10">
                <h1 ><b>le Groupe Scolaire La Tour Eiffel </b></h1>
                <h1 className={`transition-all  ease-in-out  duration-200  md:h-10 ${activestyle.title}`}><b>{lesServices[activeIndex].title2} <b>{lesServices[activeIndex].boldTitle}  </b></b></h1>
                <p className={`md:text-base text-[10px] w-full transition-all ease-in-out duration-200    md:h-20 ${activestyle.text}`}>{lesServices[activeIndex].paragrapgh} </p>
             ...
             <div className="flex-1 md:flex hidden">
                ...
                <img alt='img' className={`opacity-90 h-80 scale-125 absolute -bottom-20 transition-all ease-in-out duration-200  ${activestyle.image}`} src={process.env.PUBLIC_URL+lesServices[activeIndex].imges}></img>
                </div>
                <div className="flex-1 relative">
