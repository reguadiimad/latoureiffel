    ...
    return (
        <div className="w-[90%] md:-scroll-my-10 lg:my-20  flex-col flex  justify-center  text-neutral-900">
            ...
            <div className="w-full  lg:w-full lg:ml-0 flex  flex-col lg:flex-row  items-center mb-10 ">
                <motion.div {...costumeAnimtion('-100%')} className="flex-1 lg:w-[54%] lg:mr-[3%]  text-5xl md:text-[110px] lg:text-7xl xl:text-8xl 2xl:text-9xl  ">
                    <span className="flex">
                        <h1 className="font-normal  m-0 p-0 md:mr-4 md:mb-2"><b>VOTRE</b></h1>
                        <motion.span {...costumeAnimtion('-200%')} className=" text-center flex-1 flex items-center justify-center ">
                            <p className="bg-black/5 md:text-2xl lg:text-lg xl:text-xl 3xl:text-2xl text-[12px] lg:py-4 xl:py-6 md:py-6 py-3 w-full md:px-10 rounded-full font-semibold">SUIVEZ LEUR PROGRÈS</p>
                        </motion.span>
                    </span>
                    ...
                    <span className="flex">
                        <span className="flex-1 flex items-center  justify-center overflow-hidden">
                            <motion.div {...costumeAnimtion('-100%')} className="md:pl-8 bg-blue-500 w-full rounded-full flex items-center justify-center md:px-4 md:py-4 px-1 py-3 ds cursor-pointer">
                                <p className="w-[85%] font-semibold lg:text-lg xl:text-2xl md:text-2xl text-[12px] text-white">CONNECTEZ-NOUS</p>
                        ...
                        <h1 className="flex-1 xl:ml-4 font-normal text-right"><b>À100%</b></h1>

                    </span>
                    <p className="w-full text-neutral-900/40 mt-3 text-[10px] lg:text-sm xl:text-base md:text-base md:mb-10 lg:mb-0 text-justify ">
                ...
                <motion.div {...costumeAnimtion('70%')} className="flex-1  lg:flex-1 overflow-hidden rounded-b-[50px] z-0 iphone  relative scale-[0.7] md:scale-[1] -mt-10  md:mt-0">
                    ...
                    <div className=" w-full  top-0 left-0 z-20 p-10 lg:pt-7 xl:pt-16 pt-16 relative">
                        ...
                        <motion.img {...costumeAnimtion('70%','70%')}   alt='img' src={process.env.PUBLIC_URL+'/images/phone.png'} className="h-96 lg:h-60 xl:h-96 w-auto absolute md:-bottom-6 bottom-0 -right-40  lg:-right-24 xl:-right-40 z-0"/>
                        <p className="w-[80%] text-neutral-900/50 lg:text-xs text-base xl:text-base font-semibold">Connectez-vous à La Tour Eiffel en temps réel</p>
                        <h1 className="text-6xl lg:text-4xl xl:text-6xl mt-5"><b>Gratuitement</b></h1>
                        <p className="text-neutral-900/50 font-semibold w-full lg:text-xs text-base xl:text-base">Informez-vous instantanément sur la vie scolaire et pédagogique de votre enfant.</p>
                        <ul className="xl:mt-14 lg:mt-6 mt-14 text-neutral-900/40 ">
                            <li className="font-semibold text-blue-500 text-xl lg:text-lg xl:text-xl"><FontAwesomeIcon className="text-blue-500 text-xl mr-2 " icon={faBell}/>Restez informé</li>
                            <li className="text-sm lg:text-xs xl:text-sm">Vous serez toujours notifié et informé</li>

                            <li className="font-semibold text-red-500 text-xl lg:text-lg xl:text-xl mt-9 lg:mt-6 xl:mt-9"><FontAwesomeIcon className="text-red-500 text-xl mr-2" icon={faGlobe}/>Toujours connectés</li>
                            <li className="text-sm lg:text-xs xl:text-sm">Application toujours en ligne, rien raté.</li>

                            <li className="font-semibold text-blue-500 text-xl lg:text-lg xl:text-xl mt-9 lg:mt-6 xl:mt-9"><FontAwesomeIcon className="text-blue-500 text-xl mr-2" icon={faGear}/>Toujours à votre service</li>
                            <li className="text-sm lg:text-xs xl:text-sm w-[60%] md:w-full">Notre équipe est prête à vous aider à tout moment.</li>

                        </ul>
                        
                        <p className="text-neutral-900/20 text-[10px] lg:text-[6px] xl:text-[10px] mt-10 lg:mt-2 xl:mt-10 -mb-8">Visitez la direction de l'école ou cliquez sur "Connectez-nous" pour plus d'informations.</p>
