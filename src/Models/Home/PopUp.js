        ...
        <>
            <div className="fixed bottom-0 left-0 w-full flex items-center justify-center p-5">
                ...
                className="rounded-full flex h-16  py-3 backdrop-blur-xl pl-4 pr-2 bg-black/5 border border-white/10 shadow-lg z-50 gap-x-2">
                    ...
                    <motion.div initial={{opacity:0,width:'100%'}} animate={{opacity:1}} exit={{scale:0}} transition={{delay:0.5}}  className={`items-center ${ar&&'text-2xl'} overflo-x flex justify-center  px-2 ${white?'text-white/90':'text-black/60'}`}>
                    {text}
                    </motion.div>
